...
importScripts('https://www.gstatic.com/firebasejs/'+fbVersion+'/firebase-app.js');
importScripts('https://www.gstatic.com/firebasejs/'+fbVersion+'/firebase-messaging.js');

// Initialize the Firebase app in the service worker by passing in the
// messagingSenderId.
firebase.initializeApp(messagingConfig);
